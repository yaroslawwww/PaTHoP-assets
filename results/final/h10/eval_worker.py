...
output_path = "../assets/results/final_results_h10.csv"
...
if group_name == "BASELINE_10K":
    # 28.0, размер 10000
    res = evaluation(r_values=[28.0], ts_sizes=[10000], prediction_size=10)
elif group_name == "BASELINE_30K":
    # 28.0, размер 30000
    res = evaluation(r_values=[28.0], ts_sizes=[30000], prediction_size=10)
else:
    # Доноры: целевой 28.0 (10к) + донор r (20к)
    res = evaluation(r_values=[28.0, r_value], ts_sizes=[10000, 20000], prediction_size=10)
