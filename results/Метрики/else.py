...
def calculate_score(r1, size1, r2, size2, n_bins=32):
    """
...
# --- Параметры ---
r_values = [28, 28.01, 28.1, 28.0001, 27.99, 27.9, 27, 30, 38, 50]
main_s = 10000
else_s = 20000
main_r = 28
...
results_list = []
print(f"Вычисление метрик расхождения мер (база: r={main_r}, size={main_s})...")

for r_val in tqdm(r_values, desc="Расчет метрик"):
    current_else_s = main_s if r_val == main_r else else_s
    scores = calculate_score(main_r, main_s, r_val, current_else_s)
    print(r_val,scores)
